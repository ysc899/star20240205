...
public class VOCViewModel extends AndroidViewModel {
    ...
    private void setDefaultDate()
    {
        ...
        if( DateUtil.getFormatString(this.getSearchDate().getValue(), "yyyyMMdd").equals(DateUtil.getFormatString(toDate,"yyyyMMdd")) )
        {
            Date searchDt = this.getSearchDate().getValue();
            String searchDtStr = DateUtil.getFormatString(searchDt, "yyyyMMddHHmmss");
